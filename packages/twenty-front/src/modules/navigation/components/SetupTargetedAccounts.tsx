...
import { PersonalisationSetupAccountBasedSales } from '@/navigation/components/PersonalisationSetupAccountBasedSales';
...
export const SetupTargetedAccounts = () => {
  ...
  if (selectedForm === 'next') {
    return <PersonalisationSetupAccountBasedSales />; // Render for "By Persona"
  }
